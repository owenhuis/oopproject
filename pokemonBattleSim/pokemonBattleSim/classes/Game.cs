...
namespace pokemonBattleSim.classes
{
    class Game
    {
        ...
        public void Fight()
        {
            ...
            for (int i = 0; i < 3; i++) // Aantal Pokéballs per trainer
            {
                Charmander charmander1 = Challenger.ThrowPokeball();
                if (charmander1 != null)
                {
                    Console.WriteLine($"{charmander1.GetName()} komt uit de Pokéball!");
                ...
                if (charmander2 != null)
                {
                    Console.WriteLine($"{charmander2.GetName()} komt uit de Pokéball!");
